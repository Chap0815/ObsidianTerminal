...
_CLAIM_EXTRA_FIELDS = frozenset((
    ...
    "full_exit_mode", "full_exit_created_at", "full_exit_base_filled_amount",
    "full_exit_base_notional_sum", "full_exit_base_fee", "full_exit_outcome_uncertain",
    "partial_exit_client_order_id", "partial_exit_requested_amount", "partial_exit_position_side",
    "partial_exit_mode", "partial_exit_created_at", "partial_exit_observed_filled",
    "partial_exit_outcome_uncertain", "emergency_exit_client_order_id",
    "emergency_exit_requested_amount", "emergency_exit_outcome_uncertain",
